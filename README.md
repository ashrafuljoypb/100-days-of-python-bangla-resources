# Full tutorial of Python Programming
This is the course resources for the Official [100 Days of Python Course](https://aijoy.org/ceu/programming/python)

## Communicate with me By:
* Facebook (https://www.w3school.com)
* Facebook Page (https://www.facebook.com/Indoctrinatebd)
* Twitter (https://www.w3school.com)
* Youtube (https://www.w3school.com)
* github (https://github.com/ashrafuljoypb)
* Instagram (https://www.instagram.com/ashrafuljoypb/)
* website (https://aijoy.me/)
...
## w3school pre basic python.
*  We will start from the basic level of programming. (https://www.w3school.com)
*  Do these exercise of w3school to grab the programming preaty much. (https://www.w3school.com)

## Day 1 - Working with Variables to Manage Data

* Press the "Play" button (bottom right) to see the [Day 1 - Project Goal](https://replit.com/@aijoy/day-1-band-name-generator-end#README.md)
* [Optional - Create an account on Repl.it](https://repl.it/signup)
* Create a new repl [Day 1 Starting Code](https://replit.com/)
* [Interactive Coding Exercise - Day 1.1 Printing](https://repl.it/@aijoy/day-1-1-exercise)
* [Interactive Coding Exercise - Day 1.2 Debugging](https://repl.it/@aijoy/day-1-2-exercise)
* [Interactive Coding Exercise - Day 1.3 Inputs](https://repl.it/@aijoy/day-1-3-exercise)
* [Day 1 Ending Code](https://repl.it/@aijoy/day-1-printing-end)
...
* [Python Variables Start](https://repl.it/@aijoy/day-1-variables-start)
* [Interactive Coding Exercise - Day 1.4 Variables](https://repl.it/@aijoy/day-1-4-exercise)
* [Python Variables End](https://repl.it/@aijoy/day-1-variables-end)
* [Band Name Generator Start](https://repl.it/@aijoy/band-name-generator-start)
* [Band Name Generator Completed Code](https://repl.it/@aijoy/band-name-generator-end)

## Day 2 - Understanding Data Types and How to Manipulate Strings

* Press the "Play" button (bottom right) to see the [Day 2 - Project Goal](https://repl.it/@aijoy/tip-calculator-end?embed=1&output=1#main.py)
* Fork Your Copy of the [Day 2 Starting Code](https://repl.it/@aijoy/day-2-start)
* [Interactive Coding Exercise - Day 2.1 Data Types](https://repl.it/@aijoy/day-2-1-exercise)
* [Interactive Coding Exercise - Day 2.2 BMI Calculator](https://repl.it/@aijoy/day-2-2-exercise)
* [Interactive Coding Exercise - Day 2.3 Life in Weeks](https://repl.it/@aijoy/day-2-3-exercise)
...
* [Tip Calculator Start](https://repl.it/@aijoy/tip-calculator-start)
* [Further reading on Floating Point numbers](https://docs.python.org/2/tutorial/floatingpoint.html)
* [Tip Calculator Completed Code](https://repl.it/@aijoy/tip-calculator-end)

## Day 3 - Control Flow and Logical Operators

* Press the "Play" button (bottom right) to see the [Day 3 - Project Goal](https://repl.it/@aijoy/treasure-island-end?embed=1&output=1#main.py)
...
* Fork Your Copy of the [Day 3 Starting Code](https://repl.it/@aijoy/day-3-start)
* [Interactive Coding Exercise - Day 3.1 Odd or Even](https://repl.it/@aijoy/day-3-1-exercise)
* [Interactive Coding Exercise - Day 3.2 BMI Calculator 2.0](https://repl.it/@aijoy/day-3-2-exercise)
* [Interactive Coding Exercise - Day 3.3 Leap Year](https://repl.it/@aijoy/day-3-3-exercise)
* [Interactive Coding Exercise - Day 3.4 Pizza Order](https://repl.it/@aijoy/day-3-4-exercise)
* [Interactive Coding Exercise - Day 3.5 Love Calculator](https://repl.it/@aijoy/day-3-5-exercise)
...
* [Nested if and elif End](https://repl.it/@aijoy/day-3-nested-if-and-elif)
...
* [Multiple if statements End](https://repl.it/@aijoy/day-3-multiple-if)
...
* [Treasure Island Starting Code](https://repl.it/@aijoy/treasure-island-start)
...
* [Treasure Island Completed Code](https://repl.it/@aijoy/treasure-island-end)

## Day 4 - Randomisation and Python Lists

* Press the "Play" button (bottom right) to see the [Day 4 - Project Goal](https://repl.it/@aijoy/rock-paper-scissors-end?embed=1&output=1#main.py)
...
* Fork Your Copy of the [Day 4 Starting Code](https://repl.it/@aijoy/day-4-start)
* [Interactive Coding Exercise - Day 4.1 Heads or Tails](https://repl.it/@aijoy/day-4-1-exercise)
* [Interactive Coding Exercise - Day 4.2 Who's Paying](https://repl.it/@aijoy/day-4-2-exercise)
* [Interactive Coding Exercise - Day 4.3 Treasure Map](https://repl.it/@aijoy/day-4-3-exercise)
...
* [List of States and Veg](https://repl.it/@aijoy/day-4-list-practice)
...
* [Rock Paper Scissors Starter Code](https://repl.it/@aijoy/rock-paper-scissors-start)
* [Rock Paper Scissors Completed Code](https://repl.it/@aijoy/rock-paper-scissors-end)

## Day 5 - Python Loops

* Press the "Play" button (bottom right) to see the [Day 5 - Project Goal](https://repl.it/@aijoy/password-generator-end?embed=1&output=1#main.py)
* [Have I been pwned?](https://haveibeenpwned.com/)
* Fork Your Copy of the [Day 5 Starting Code](https://repl.it/@aijoy/day-5-start)
* [Interactive Coding Exercise - Day 5.1 Average Height](https://repl.it/@aijoy/day-5-1-exercise)
* [Interactive Coding Exercise - Day 5.2 Highest Score](https://repl.it/@aijoy/day-5-2-exercise)
* [Interactive Coding Exercise - Day 5.3 Adding Evens](https://repl.it/@aijoy/day-5-3-exercise)
* [Interactive Coding Exercise - Day 5.4 FizzBuzz](https://repl.it/@aijoy/day-5-4-exercise)
* [For loop Lesson End](https://repl.it/@aijoy/day-5-for-loops-end)
* [Day 5 Ending Code](https://repl.it/@aijoy/day-5-end)
* [Password Generator Start](https://repl.it/@aijoy/password-generator-start)
* [Password Generator Completed Code](https://repl.it/@aijoy/password-generator-end) 
...
* Press the "Play" button (bottom right) to see the [Day 17 - Project Goal](https://repl.it/@appbrewery/quiz-game-final?embed=1&output=1#main.py)
...
* [Completed Code NATO Alphabet Project](https://repl.it/@appbrewery/NATO-alphabet-end.zip)
...
* [Day 57 End](https://repl.it/@appbrewery/day-57-end.zip)
...
* [Blog Project Completed Code](https://repl.it/@appbrewery/blog-templating-end.zip)
